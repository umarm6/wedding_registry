...
add_action('woocommerce_order_status_completed', 'process_payment');
    ...
    function process_payment($order_id){
        ...
        foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
            ...
            $wpdb->query($wpdb->prepare( "UPDATE $wedding_registry_item SET received_qty=CONCAT($quantity+$productcheck_qty)  WHERE wish_id=%d AND variation_id=%d AND product_id=%d",$whishlisID,$varID,$prodID));
